...
abstract class Fixtures extends \PHPUnit_Framework_TestCase {
    ...
    protected function getFilterCollectionEntriesVoter() {
        return new FilterCollectionEntriesVoter(new OrEntriesDelegator(new EntryDelegator()), $this->getFilterEntriesVoter());
    }
    ...
    protected function getFilterEntriesVoter() {
        return new FilterEntriesVoter($this->getContainerVoter(), new AndEntriesDelegator(new EntryDelegator()));
    }

    /**
     * @return VoterInterface
     */
    protected function getContainerVoter() {
        return new FilterVoter(array(
            "substr" => new StringContainsVoter(new OrEntriesDelegator(new NegationEntryDelegator()), "substr", "foo bar"),
